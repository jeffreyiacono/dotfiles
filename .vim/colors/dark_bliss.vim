...
let g:colors_name="dark_bliss"

hi Normal         guifg=#eeeeee           guibg=#001122
hi Cursor         guifg=#001122           guibg=#ccffcc
...
hi Comment        guifg=#aaccaa           gui=italic
hi Constant       guifg=#f0f0aa           gui=bold
hi Exception      guifg=#ffaa88
hi String         guifg=#bbbbff
hi Variable       guifg=#7587a6           gui=bold
hi Define         guifg=#7587a6
hi Identifier     guifg=#ffbb66           gui=bold
hi Statement      guifg=#cda869
hi Keyword        guifg=#ccffaa           gui=bold
hi PreProc        guifg=#aaffee
